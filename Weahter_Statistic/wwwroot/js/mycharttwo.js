...
function DeclareArray() {
    ...
    arrayPressure1 = new Array(arrayInfo1.length);
    arrayPressure2 = new Array(arrayInfo1.length);
    arrayHum1= new Array(arrayInfo1.length);
    arrayHum2 = new Array(arrayInfo1.length);
    arrayClo1 = new Array(arrayInfo1.length);
    arrayClo2 = new Array(arrayInfo1.length);
    arrayTemp1 = new Array(arrayInfo1.length);
...
function FillArray() {
    for (var i = 0; i < arrayInfo1.length; i++) {
        ...
        arrayPressure1[i] = arrayInfo1[i].pressure;
        arrayPressure2[i] = arrayInfo2[i].pressure;

        arrayHum1[i] = arrayInfo1[i].humadity;
        arrayHum2[i] = arrayInfo2[i].humadity;

        arrayClo1[i] = arrayInfo1[i].cloudy;
        arrayClo2[i] = arrayInfo2[i].cloudy;

        arrayTemp1[i] = new Array(2);
        arrayTemp1[i][0] = arrayInfo1[i].minTemp;
        arrayTemp1[i][1] = arrayInfo1[i].maxTemp;

        arrayTemp2[i] = new Array(2);
        arrayTemp2[i][0] = arrayInfo2[i].minTemp;
        arrayTemp2[i][1] = arrayInfo2[i].maxTemp;
        arrayWind1[i] = new Array(2);
        arrayWind1[i][0] = arrayInfo1[i].windspeed;
        arrayWind1[i][1] = arrayInfo1[i].directNumber;
        arrayWind2[i] = new Array(2);
        arrayWind2[i][0] = arrayInfo2[i].windspeed;
        arrayWind2[i][1] = arrayInfo2[i].directNumber;
